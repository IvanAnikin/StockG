...
input_sample = pd.DataFrame({"Date": pd.Series(["2000-1-1"], dtype="datetime64[ns]"), "Open": pd.Series([0.0], dtype="float64"), "High": pd.Series([0.0], dtype="float64"), "Low": pd.Series([0.0], dtype="float64"), "Close": pd.Series([0.0], dtype="float64"), "Volume": pd.Series([0], dtype="int64")})
